...
public final class NotesContract {
    ...
    public static final String AUTHORITY = "projects.zaharova.notes.provider";
    ...
    public static abstract class Notes implements BaseColumns {
        ...
        public static final String URI_TYPE_NOTE_DIR = "vnd.android.cursor.dir/vnd.zaharova.note";
        public static final String URI_TYPE_NOTE_ITEM = "vnd.android.cursor.item/vnd.zaharova.note";
        ...
        public static final String CREATE_TABLE = String.format("CREATE TABLE %s " + "(%s INTEGER PRIMARY KEY, " + "%s TEXT NOT NULL, " + "%s TEXT NOT NULL, " + "%s INTEGER NOT NULL, " + "%s INTEGER NOT NULL);",
                TABLE_NAME,
                _ID,
                COLUMN_TITLE,
                COLUMN_NOTE,
